export default function Forecast() {
    return (
        <section className="mb-6 md:mb-8" aria-labelledby="forecast-label">
            <h2 id="forecast-label" className="text-title-2 md:mb-4 font-semiBold mb-2">5 Days Forecast</h2>

            {/* {forecast-card} */}
            <div className="card bg-surface card-lg">
                <ul>
                    {/* card-item */}
                    <li className="flex items-center mb-7 md:mb-8 last-of-type:mb-0">
